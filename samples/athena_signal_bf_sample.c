...
int athena_signal_bf_sample(char* input_file, int bf_type, int mic_num, float* mic_coord, float loc_phi, char* output_file)
{
    int ret;
...
int main(int argc, char** argv)
{
    ...
    while (1) {
        ...
        int option_index = 0;
        c = getopt_long(argc, argv, "b:f:hi:l:m:o:", long_options, &option_index);
    ...
    athena_signal_bf_sample(input_file, bf_type, mic_num, mic_coord, loc_phi, output_file);
